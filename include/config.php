...
$data['sada'] = array ('1'=>'sada!192.168.1.21','sada@|@admin','sada#|#qJKWmZ+ZaWM=','sada%ww','sada^distrik51.id','sada&Rp','sada*10','sada(1','sada)','sada=10','sada@!@disable');
$data['ds'] = array ('1'=>'ds!192.168.1.21','ds@|@admin','ds#|#qJKWmZ+ZaWM=','ds%das','ds^distrik51.id','ds&Rp','ds*10','ds(1','ds)','ds=10','ds@!@disable');
